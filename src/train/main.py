...
from utils.training import init_weights, init_transformer_weights, topk_acc, get_lr, seed_everything
import config.NeuralChessBot as NNCONFIG
import config.T22ChessBot as TRFCONFIG
...
if __name__ == "__main__":
    ...
    for it in range(start_iter, start_iter + CONFIG.MAX_ITERS):
        ...
        if it % CONFIG.VERBOSE_INTERVAL == 0 and it > 0:
