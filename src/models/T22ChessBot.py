...
import config.T22ChessBot as CONFIG
import random
...
class T22ChessBot:
    def __init__(self):
        ...
        self.model = T22ChessModel().to(self.device)

        # Load the model parameters
        model_path = Path(__file__).resolve().parents[2]/'checkpoints/t22_best_model.pth'
